...
// evento para saber se sao 2 players ou com IA
...
function checkWinCondition() {
    ...
    if(counter == 9) {
        declareWinnder("deu velha");
    }

}

// limpar jogo, declarar vencedor e atualizar o placar
function declareWinnder(winner) {
